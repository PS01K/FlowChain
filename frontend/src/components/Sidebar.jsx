            ...
            <nav className="flex-1 p-4 space-y-1">
                {navItems.map((item) => {
                    ...
                    return (
                        <button
                            key={item.id}
                            className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 group ${item.active
                        ...
                        >
                            <Icon
                                className={`w-5 h-5 transition-all duration-200 ${item.active
